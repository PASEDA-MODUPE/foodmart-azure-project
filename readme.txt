...
![Azure CLI](https://img.shields.io/badge/Azure-CLI-0078D4)
...
![FoodMart Homepage](screenshots/homepage.png)
...
- Deployed a containerized web application to Azure Container Apps.
- Built and managed Docker images.
- Stored container images in Azure Container Registry (ACR).
- Configured Managed Identity and RBAC for secure registry access.
- Automated deployments with GitHub Actions.
- Monitored application logs using Azure Log Analytics.
